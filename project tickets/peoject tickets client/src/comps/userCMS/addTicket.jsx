...
export default function AddUserTicket() {
    ...
    return (
      <div className='container d-flex flex-column align-items-center py-5'>
        ...
        <h1 className='display-3'>Add new Ticket</h1>
        { categories.length > 0 ?
  ...
  {/* !loading - for prevent from user click twice or more on the btn adn add multi categories  */}
                  ...
                  <button className='btn btn-dark  mt-3 mx-2' type='button' onClick={()=> nav(-1)}>Back</button>
              </form> : 
              <h2>Loading...</h2>
              }
