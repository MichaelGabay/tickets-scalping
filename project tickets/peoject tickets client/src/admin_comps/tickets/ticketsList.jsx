...
export default function TicketsList() {
    ...
    const doApi = async () => {
        ...
        let url = API_URL + '/tickets?page='+pageQ
    ...
    return (
        <div className='container'>
            ...
            <AdminAuthComp />
            <Link to={'/admin/add_ticket'} className='btn btn-info mt-4 mb-1' >Add Ticket</Link>
            {!loading ? 
                        ...
                        return (
                            ...
                            <tr key={item._id} >
                                ...
                                <td>
                                    ...
                                    <Link to={'/admin/editTicket/' + item._id} className='btn badge bg-info px-3 py-2'>Edit</Link>
                                </td>
                            </tr>
                        )
                    })}
